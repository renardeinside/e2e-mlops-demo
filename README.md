...
```
This command will create your personal repository under `/Repos/<username>/e2e_mlops_demo`.
3. To set up the CI/CD pipeline with the notebook, create a separate `Staging` repo:
```bash
databricks repos create --url <your repo URL> --provider <your-provider> --path /Repos/Staging/e2e_mlops_demo
```
